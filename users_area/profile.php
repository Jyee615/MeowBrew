...
<body>
    ...
    <!-- Sidebar -->
    <div class="col-md-3" style="background-color: #644535; height: 100vh; padding: 20px; color: white;">
        <div class="text-center mb-4">
            ...
            $userprofileimage_result = mysqli_query($con, $userprofileimage_query);
            $row_profileimage = mysqli_fetch_array($userprofileimage_result);
            $userprofileimage = !empty($row_profileimage['UserImage']) ? $row_profileimage['UserImage'] : 'default.jpg';

            echo "
            <img src='./users_images/$userprofileimage' class='rounded-circle' alt='Profile Picture' 
                style='width: 120px; height: 120px; object-fit: cover; margin-bottom: 15px; border: 3px solid #fff;'>
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link text-light" href="profile.php?edit_profile">
                    <i class="fas fa-user-edit me-2"></i>Edit Profile
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="profile.php">
                    <i class="fas fa-box me-2"></i>Pending Orders
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-light" href="profile.php?delete_acc">
